...
const QuizAnswerHandler = {
    ...
    handle(handlerInput) {
        ...
        if (previousQuestions.length >= maxQuestions) {
            ...
            speakOutput += " Do you want to answer another question? Say yes or no, or say listen to listen to this podcast.";
            repromptOutput = "Say yes for another question, listen to listen to this podcast, or no to stop.";
...
const ErrorHandler = {
    ...
    //console.log("Inside ErrorHandler - handle");
        console.log("Error handled: " + error + " Type: " + handlerInput.requestEnvelope.request.type + "\n" + error.stack);
...
exports.handler = Alexa.SkillBuilders
    ...
    .addRequestHandlers(
        ...
        Podcaster.playLatestHandler(),
        Podcaster.playThisHandler(),
        Podcaster.pauseHandler(),
        Podcaster.playbackStartedHandler(),
        Podcaster.playbackStoppedHandler(),
        Podcaster.cancelHandler(),
        Podcaster.resumeHandler(),
        Podcaster.startOverHandler(),
        HelpHandler,
        ExitHandler,
        SessionEndedRequestHandler,
        Podcaster.unsupportedIntentHandler()
    )
